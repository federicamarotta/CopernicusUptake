...
#
# This script was modified by Amber McCullum: NASA ARSET 
...
setwd("C:/Users/Fede/Desktop/PHD/Corsi/copernicus_uptake/ARSET-Change_Detection_for_Land_Cover_Mapping/classification.R_NASA")
# Name and path for the Shapefile (don't need the .shp extension)
shapefile <- '/Users/Fede/Desktop/PHD/Corsi/copernicus_uptake/ARSET-Change_Detection_for_Land_Cover_Mapping/classification.R_NASA/training.shp'
# Class numbers that you want to select training sample from
classNums <- c(11,12,21,22,23,33,42,44)
...
classSampNums <- c(100,100,100,100,100,100,100,100)
...
inImageName <-'2018_2021_stacked_change_cut.tif'
...
outImageName<-'2018_2021_stacked_change_cut_RF.tif'
